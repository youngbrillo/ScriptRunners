...
void ECS::InteractableNode::Extend(lua_State* L)
{
	luabridge::getGlobalNamespace(L)
		.beginNamespace("ECS")
			.beginClass<ECS::Icon>("Icon")
				.addData("frame", &ECS::Icon::frame)
				.addData("destination", &ECS::Icon::destination)
				.addData("origin", &ECS::Icon::origin)
				.addData("rotation", &ECS::Icon::rotation)
			.endClass()
			.deriveClass<ECS::InteractableNode, ECS::Node2d>("InteractableNode")
				...
				.addData("icon", &ECS::InteractableNode::icon)
				.addData("isInteractive", &ECS::InteractableNode::isInteractive)
			.endClass()
		.endNamespace();
}
